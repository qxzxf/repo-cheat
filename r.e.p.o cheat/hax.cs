...
namespace r.e.p.o_cheat
{
    public static class UIHelper
    {
        ...
        {
            // Стильная кнопка с современным дизайном
            GUIStyle buttonStyle = new GUIStyle(GUI.skin.button)
            {
                ...
                normal = {
                    ...
                    background = MakeSolidBackground(new Color(0.25f, 0.25f, 0.3f), 0.9f)
                },
                hover = {
                    textColor = Color.white,
                    background = MakeSolidBackground(new Color(0.3f, 0.3f, 0.35f), 0.95f)
                },
                active = {
                    textColor = Color.white,
                    background = MakeSolidBackground(new Color(0.35f, 0.35f, 0.4f), 1f)
                },
        ...
        public static bool Checkbox(string text, bool value, float? customX = null, float? customY = null)
        {
            GUIStyle toggleStyle = new GUIStyle(GUI.skin.toggle)
            {
                ...
                onNormal = { textColor = new Color(0.9f, 0.9f, 0.9f) },
            ...
            return GUI.Toggle(NextControlRect(customX, customY), value, text, toggleStyle);
        }
        ...
        {
            // Современный стиль для слайдера
            if (sliderStyle == null)
            {
                sliderStyle = new GUIStyle(GUI.skin.horizontalSlider)
                {
                    normal = { background = MakeSolidBackground(new Color(0.3f, 0.3f, 0.35f), 0.8f) },
                    hover = { background = MakeSolidBackground(new Color(0.35f, 0.35f, 0.4f), 0.9f) },
                    active = { background = MakeSolidBackground(new Color(0.4f, 0.4f, 0.45f), 1f) },
                    fixedHeight = 6
                };
            }
            if (thumbStyle == null)
            {
                ...
                {
                    normal = { background = MakeSolidBackground(new Color(0.7f, 0.7f, 0.8f), 1f) },
                    hover = { background = MakeSolidBackground(new Color(0.8f, 0.8f, 0.9f), 1f) },
                    active = { background = MakeSolidBackground(new Color(0.4f, 0.8f, 1f), 1f) },
                    fixedWidth = 16,
                    fixedHeight = 16
                };
            }
        ...
        public static bool ButtonBool(string text, bool value, float? customX = null, float? customY = null)
        {
            ...
            // Современный стиль кнопки с закругленными углами и градиентом
            ...
            { 
                ...
                fontStyle = FontStyle.Bold,
                normal = { 
                    textColor = value ? new Color(0.2f, 0.9f, 0.2f) : new Color(0.9f, 0.2f, 0.2f),
                    background = MakeSolidBackground(value ? new Color(0.2f, 0.3f, 0.35f) : new Color(0.25f, 0.25f, 0.3f), 0.9f)
                },
                hover = {
                    textColor = value ? new Color(0.3f, 1f, 0.3f) : new Color(1f, 0.3f, 0.3f),
                    background = MakeSolidBackground(value ? new Color(0.25f, 0.35f, 0.4f) : new Color(0.3f, 0.3f, 0.35f), 0.95f)
                },
                active = {
                    textColor = Color.white,
                    background = MakeSolidBackground(value ? new Color(0.3f, 0.4f, 0.45f) : new Color(0.35f, 0.35f, 0.4f), 1f)
                },
                margin = new RectOffset(4, 4, 4, 4),
                padding = new RectOffset(8, 8, 4, 4)
            };
    ...
    public class Hax2 : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            // Закомментировано для компиляции
            /*if (r.e.p.o_cheat.NoclipController.noclipActive)
            {
                r.e.p.o_cheat.NoclipController.UpdateMovement();
            }*/
        }
        ...
        public void OnGUI()
        {
            ...
            // Обновленная версия информации о чите в верхнем углу экрана
            GUIStyle infoStyle = new GUIStyle(GUI.skin.label);
            infoStyle.fontSize = 12;
            infoStyle.fontStyle = FontStyle.Bold;
            infoStyle.normal.textColor = new Color(0.9f, 0.9f, 0.9f);
            GUI.Label(new Rect(10, 10, 300, 30), "R.E.P.O CHEAT | DEL - MENU", infoStyle);
            GUI.Label(new Rect(198, 10, 300, 30), "MADE BY qxzxf", infoStyle);

            if (showMenu)
            {
                // Полупрозрачный оверлей для фона
                GUIStyle overlayStyle = new GUIStyle();
                overlayStyle.normal.background = MakeSolidBackground(new Color(0, 0, 0, 0.3f), 0.3f);
                ...
                // Стилизация основного окна меню
                if (menuStyle == null)
                {
                    menuStyle = new GUIStyle(GUI.skin.box);
                    menuStyle.normal.background = MakeSolidBackground(new Color(0.12f, 0.12f, 0.14f, 0.95f), 0.95f);
                ...
                titleStyle.normal.background = MakeSolidBackground(new Color(0.17f, 0.17f, 0.2f, 1f), 1f);
                titleStyle.normal.textColor = new Color(0.9f, 0.9f, 0.9f);
                titleStyle.fontSize = 16;
                titleStyle.fontStyle = FontStyle.Bold;
                titleStyle.alignment = TextAnchor.MiddleCenter;
                
                GUI.Box(titleRect, "R.E.P.O Elite Menu v2.0 | by qxzxf", titleStyle);
                UIHelper.Begin("", menuX, menuY, 600, 800, 30, 30, 10);

                // Код для перетаскивания окна меню
                ...
                GUIStyle tabStyle = new GUIStyle(GUI.skin.button)
                {
                    ...
                    fontStyle = FontStyle.Bold,
                    alignment = TextAnchor.MiddleCenter,
                    normal = { textColor = new Color(0.8f, 0.8f, 0.8f), background = MakeSolidBackground(new Color(0.22f, 0.22f, 0.25f), 1f) },
                    hover = { textColor = new Color(1f, 1f, 1f), background = MakeSolidBackground(new Color(0.25f, 0.25f, 0.3f), 1f) },
                    active = { textColor = new Color(1f, 1f, 1f), background = MakeSolidBackground(new Color(0.3f, 0.3f, 0.35f), 1f) }
                };
                GUIStyle selectedTabStyle = new GUIStyle(tabStyle)
                {
                    normal = { textColor = new Color(1f, 1f, 1f), background = MakeSolidBackground(new Color(0.35f, 0.35f, 0.4f), 1f) }
                };
                ...
                // Информационные подсказки с красивым оформлением
                ...
                GUI.Label(new Rect(menuX + 10, menuY + 75, 580, 20), "Press F5 to reload | DEL to close | F10 to unload", instructionStyle);
                
                // Линия-разделитель
                Texture2D lineTex = MakeSolidBackground(new Color(0.4f, 0.4f, 0.45f), 1f);
                GUI.DrawTexture(new Rect(menuX + 10, menuY + 95, 580, 1), lineTex);
                ...
                switch (currentCategory)
                {
                    case MenuCategory.Player:
                        ...
                        // Закомментировано для компиляции
                        /*bool newNoclipActive = UIHelper.ButtonBool("Toggle Noclip", r.e.p.o_cheat.NoclipController.noclipActive, menuX + 30, menuY + 475);
                        if (newNoclipActive != r.e.p.o_cheat.NoclipController.noclipActive) { r.e.p.o_cheat.NoclipController.ToggleNoclip(); r.e.p.o_cheat.NoclipController.noclipActive = newNoclipActive; }*/
